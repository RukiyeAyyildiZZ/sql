...
insert into insanlar values(null,'Er');  --> NOT NULL SEBEBIYLE ERROR VERIR
...
insert into hayvanlar values('Fındık','Sus Kopegi') -->COMPOSITE PRIMARY KEY SEBEBIYLE ERROR VERDI
...
2)COMPOSITE PRIMARY KEY yapmamiza imkan veriyor.(Iki sutunun birlesiminden bir Primary Key olusturulmasina)
*/
...
--Soru 1 : doktorlar tablosuna gorev_yeri 'Meddem' olan veri girisi yapiniz

insert into doktorlar values('Meddem','Hakki Oz','159624','noroloji');

--Soru 2 : doktorlar tablosuna gorev_yeri 'Okmeydani' olan veri girisi yapiniz

--not:parent tabloda olmayan primary key ile child tabloya veri girisi yapilamaz

insert into doktorlar values('Okmeydani','Hatice Kar','145796','ortopedi'); --bu sebeple bu kod calismaz
...
insert into doktorlar values(null,'Hasim Dal','148627','noroloji');
 ...
 delete from hastaneler where hastane_adi='Meddem'; --bu sebeple bu kod error verir
